...
ufc_df_raw = pd.read_csv(r'C:\Users\Usuario\Desktop\DS\ufc\github\ufc-master.csv')
...
# ufc_fighters_df.to_excel(r'C:\Users\Usuario\Desktop\DS\ufc\github2\ufc_fighters.xlsx')
...
grouped.to_excel(r'C:\Users\Usuario\Desktop\DS\ufc\github2\ufc_fighters_all.xlsx')

for index in range(0, 58):  # Intervalo de linhas 0 a 57 (lembrando que o índice começa em 0)
    old_date = ufc_df_raw.at[index, 'date']
    parts = old_date.split('-')
    year = parts[0]
    month = parts[1]
    day = parts[2]
    new_date = f"{int(month)}/{int(day)}/{year}"  # Convertendo para formato 'm/d/Y'
    ufc_df_raw.at[index, 'date'] = new_date

# Converter a coluna 'date' para o tipo datetime.
ufc_df_raw['date'] = pd.to_datetime(ufc_df_raw['date'])   
ufc_df_raw.to_excel(r'C:\Users\Usuario\Desktop\DS\ufc\github2\ufc_fights.xlsx')
